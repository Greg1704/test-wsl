...
- **Secrets:** van en `.env` (gitignored) en local y en las *Environment Variables* de Vercel en producción (GitHub Secrets para lo que use el CI). Incluí siempre un `.env.example` sin valores reales. Nunca hardcodees secrets.
