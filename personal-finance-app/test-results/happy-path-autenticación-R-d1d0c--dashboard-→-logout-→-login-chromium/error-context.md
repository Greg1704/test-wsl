...
- Name: happy-path.spec.ts >> autenticación (RNF-6.3, parte 1) >> signup → dashboard → logout → login
- Location: e2e/happy-path.spec.ts:8:7

# Error details

```
Error: page.goto: net::ERR_SSL_PROTOCOL_ERROR at http://app:3000/signup
Call log:
  - navigating to "http://app:3000/signup", waiting until "load"
